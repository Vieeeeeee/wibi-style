...
<p>
<b>26</b> individually installable visual style Skills ·
...
| <a href="skills/warm-paper-crayon-street/"><img src="assets/thumbs/warm-paper-crayon-street.jpg" width="140" alt="Warm Paper Crayon Street"></a><br><a href="skills/warm-paper-crayon-street/">Warm Paper Crayon Street</a> |  |  |  |  |

## All styles

26 styles right now — find yours by the photo you have. Click a name for its detail page; the call name is both the last part of the install URL and the `$` command you use.
