...
<p>
<b>30</b> individually installable visual style Skills ·
...
30 styles right now — find yours by the photo you have. Click a name for its detail page; the call name is both the last part of the install URL and the `$` command you use.
