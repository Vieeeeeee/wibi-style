...
| `assets/references/sketch-black.png` | 项目素材 `01_风格参考/03_黑白手绘票根.png`，SHA-256：`59738d3410a37c540e32883e4e7a7e61fe3cf356aba6d01995856cfb1872e9f8` | 项目作者选择进入本次公开包，按 LICENSE 作为运行参考分发 |
| `assets/references/signal-coral.png` | 项目素材 `01_风格参考/04_珊瑚黑墨票根.png`，SHA-256：`af2dff40bb3521d7b93b725e4e37c5bb7b8889b0931d593c012d8026741416ac` | 项目作者选择进入本次公开包，按 LICENSE 作为运行参考分发 |

作者：`@威比 Hunter Wei.`（抖音、小红书同名）。官方来源：`https://github.com/Vieeeeeee/wibi-style/tree/main/skills/personalized-print-ticket`。

本包携带四张运行参考，每次依据用户照片和选择只使用对应的一张。案例原图和用户照片不进入安装包；六张 README 展示成图只存放在仓库 `docs/`，不随单款安装。
