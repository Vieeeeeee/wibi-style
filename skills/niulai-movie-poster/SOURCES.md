...
以下三张是项目内角色参考的单角色裁切版本，只承担角色头脸设计，不包含案例原图或用户照片：

- `assets/references/role-yellow-big-cow.png`：`97fb9c7fd6b02b20d1b0b6ff4a2f61182ee23ff5eaae82572071aacfac02dc6b` ← `01_风格参考/07_角色设定_黄色大牛单角色.png`
- `assets/references/role-orange-small-cow.png`：`7a147bf7b4674c20d1a460aa61a958e69f076d691a6e2dd24a8b94cf67932101` ← `01_风格参考/08_角色设定_橙色小牛单角色.png`
- `assets/references/role-yellow-black-spotted-leopard.png`：`1241212bf37c81656c0a601399bd1be1fccc3dedc90f59e5c99e99c757d14a8f` ← `01_风格参考/09_角色设定_黄色黑斑豹单角色.png`
