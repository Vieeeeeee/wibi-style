...
| 内容 | 来源 | 版权状态 |
| --- | --- | --- |
| `SKILL.md`、`references/style-prompt.md` | 地下试镜skill项目的真实案例迭代：17 轮 Prompt 版本（v1–v17），在 4 位测试对象（女生、戴眼镜男生、卷发男生、短发男生）上反复验证 | © 2026 @威比 Hunter Wei.，按本包 LICENSE 授权 |
...
仓库 `docs/underground-audition/examples/` 展示六张实际生成结果，只供 README 展示风格效果，不随单款 Skill 安装；这六张来自已验收的真实生成结果，随 v1.1.3 一并完成远端回查。
