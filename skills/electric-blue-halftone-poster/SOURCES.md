...
作者：`@威比 Hunter Wei.`（抖音、小红书同名）。官方来源：`https://github.com/Vieeeeeee/wibi-style/tree/main/skills/electric-blue-halftone-poster`。

仓库 `docs/electric-blue-halftone-poster/examples/` 中另有六张实际生成结果，只供 README 展示风格效果，不随单款 Skill 安装。项目所有者已确认公开展示这些成图；对应原始照片未上传。展示图的来源哈希与使用边界见该目录的 `SOURCES.md`。
