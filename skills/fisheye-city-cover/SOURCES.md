...
内置参考的公开再分发状态已由用户于 2026-08-14 明确确认。本记录只陈述用户提供的来源与授权判断；发布时仍保留文件路径、SHA-256 和运行职责，且不得把参考中的人物、品牌、Logo 或原文字当作生成内容。

作者：`@威比 Hunter Wei.`（抖音、小红书同名）。官方来源：`https://github.com/Vieeeeeee/wibi-style/tree/main/skills/fisheye-city-cover`。
