...
| <a href="skills/personalized-print-ticket/"><img src="assets/thumbs/personalized-print-ticket.jpg" width="140" alt="定制印刷票根"></a><br><a href="skills/personalized-print-ticket/">定制印刷票根</a> |  |  |  |  |

## 全部风格

当前共 31 款，按你手上的照片找。点击风格名进入详情页；调用名同时是安装地址的最后一段和使用时的 `$` 指令。
