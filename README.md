...
| <a href="skills/warm-paper-crayon-street/"><img src="assets/thumbs/warm-paper-crayon-street.jpg" width="140" alt="暖纸蜡笔街拍"></a><br><a href="skills/warm-paper-crayon-street/">暖纸蜡笔街拍</a> |  |  |  |  |

## 全部风格

当前共 26 款，按你手上的照片找。点击风格名进入详情页；调用名同时是安装地址的最后一段和使用时的 `$` 指令。
