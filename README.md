...
<a href="#all-styles"><img src="https://img.shields.io/badge/Styles-32%20Ready--to--Use-6f42c1.svg" alt="32 Styles"></a>
</p>

<p>
<b>32</b> individually installable visual style Skills ·
...
| <a href="skills/personalized-print-ticket/"><img src="assets/thumbs/personalized-print-ticket.jpg" width="140" alt="Personalized Print Ticket"></a><br><a href="skills/personalized-print-ticket/">Personalized Print Ticket</a> | <a href="skills/paper-flat-vignette/"><img src="assets/thumbs/paper-flat-vignette.jpg" width="140" alt="Paper Flat Vignette"></a><br><a href="skills/paper-flat-vignette/">Paper Flat Vignette</a> |  |  |  |

## All styles

32 styles right now — find yours by the photo you have. Click a name for its detail page; the call name is both the last part of the install URL and the `$` command you use.
